package com.jsdroid.widget.tree.model;
...
import com.jsdroid.widget.tree.R;
import com.jsdroid.widget.tree.view.AndroidTreeView;
import com.jsdroid.widget.tree.view.TreeNodeWrapperView;
...
public class TreeNode<T> {
    ...
    public int deleteChild(TreeNode<T> child) {
    ...
    public boolean isLastChild() {
        if (!isRoot()) {
            ...
            if (parentSize > 0) {
                final List<TreeNode<T>> parentChildren = mParent.children;
    ...
    public boolean isFirstChild() {
        if (!isRoot()) {
            List<TreeNode<T>> parentChildren = mParent.children;
