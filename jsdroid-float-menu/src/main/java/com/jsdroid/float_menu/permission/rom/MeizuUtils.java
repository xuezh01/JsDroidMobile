 ...
 */
package com.jsdroid.float_menu.permission.rom;
...
import com.jsdroid.float_menu.permission.FloatPermissionHelper;
...
//            intent.setClassName("com.meizu.safe", "com.meizu.safe.security.AppSecActivity");//remove this line code for fix flyme6.3
            ...
            context.startActivityForResult(intent, FloatPermissionHelper.REQUEST_CODE_FLOAT_PERMISSION);
        } catch (Exception e) {
            try {
                Log.e(TAG, "获取悬浮窗权限, 打开AppSecActivity失败, " + Log.getStackTraceString(e));
                // 最新的魅族flyme 6.2.5 用上述方法获取权限失败, 不过又可以用下述方法获取权限了
                FloatPermissionHelper.commonROMPermissionApplyInternal(context);
