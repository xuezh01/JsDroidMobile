...
public class TreeViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (onTreeNodeListener != null && onTreeNodeListener.onClick(position, selectedNode, holder))
                    return;
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if (onTreeNodeListener != null) {
                    TreeNode selectedNode = displayNodes.get(holder.getLayoutPosition());
                    return onTreeNodeListener.onLongClick(position, selectedNode, holder);
                }
                return false;
            }
        });
    ...
    public interface OnTreeNodeListener {
         ...
         */
        boolean onClick(int position, TreeNode node, RecyclerView.ViewHolder holder);

        boolean onLongClick(int position, TreeNode node, RecyclerView.ViewHolder holder);
    ...
    public void refresh(TreeNode treeNode) {
        refresh(Arrays.asList(treeNode));
    }
