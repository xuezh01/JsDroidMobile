...
public final class Rect {
	 ...
	 * 
	 * @param dx
	 *            The amount to next to the rectangle's left and right
	 *            coordinates
	 * @param dy
	 *            The amount to next to the rectangle's top and bottom
	 *            coordinates
	 */
	 ...
	 * 
	 * @param dx
	 *            The amount to next(subtract) from the rectangle's left(right)
	 * @param dy
	 *            The amount to next(subtract) from the rectangle's top(bottom)
	 */
	 ...
	 * 
	 * @param x
	 *            The x coordinate of the point to next to the rectangle
	 * @param y
	 *            The y coordinate of the point to next to the rectangle
	 */
