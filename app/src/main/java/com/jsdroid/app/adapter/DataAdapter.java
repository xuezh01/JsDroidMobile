...
public class DataAdapter extends BaseAdapter {
    public static abstract class DataRender {
    ...
    public static class ViewHolder {
        ...
        public void loadData(int viewId, ViewTool.LoadCallback callback) {
            createViewTool(viewId).loadData(callback);
        }

        public void loadData(View view, ViewTool.LoadCallback callback) {
            new ViewTool(view).loadData(callback);
        }
    ...
    public static class ViewTool {
        ...
        public static class LoadDataAsync {
            ...
            public LoadDataAsync(View view, LoadCallback callback) {
                this.view = view;
            ...
            public void execute() {
                view.setTag(R.id.tag_single_flag, getHashCode());
                    ...
                    public void run() {
                        ...
                        if (result == null) {
                            ...
                            view.post(new Runnable() {
                                @Override
                                public void run() {
                                    if (getHashCode() == (int) view.getTag(R.id.tag_single_flag)) {
        ...
        public void setImage(int id, final int resId) {
            createViewTool(id).setImage(resId);
        }
        ...
        public void loadData(LoadCallback callback) {
            new LoadDataAsync(mView, callback).execute();
        }
    ...
    public DataAdapter(Context context) {
        dataRenders = new ArrayList<DataRender>();
        datas = new ArrayList();
        viewHolderCaches = new ArrayList<ViewHolder>();
    }

    public void addDataRender(DataRender dataRender) {
    ...
    private DataRender getDataHandler(int pos, Object data) {
        for (DataRender dataRender : dataRenders) {
            if (dataRender.canFillData(data) || dataRender.canFillData(pos)) {
                return dataRender;
            }
        }
        return null;
    ...
    private View getView(int position, Object data, View convertView,
        ...
        DataRender dataRender = getDataHandler(position, data);
        ViewHolder vh = ViewHolder.get(this, layout,
                dataRender.getLayoutId());
        dataRender.fillData(position, data, vh, this);
        return layout;
    }
