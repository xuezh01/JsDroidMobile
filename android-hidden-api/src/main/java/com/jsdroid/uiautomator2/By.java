...
public class By {
    ...
    public static BySelector map(Map map) {
        BySelector ret = new BySelector();
        ...
        if (map.containsKey("textContains")) {
            ret.textContains(map.get("textContains").toString());
        }
        if (map.containsKey("textEndsWith")) {
            ret.textEndsWith(map.get("textEndsWith").toString());
        }
        if (map.containsKey("textStartsWith")) {
            ret.textStartsWith(map.get("textStartsWith").toString());
        }

        if (map.containsKey("descContains")) {
            ret.descContains(map.get("descContains").toString());
        }
        if (map.containsKey("descEndsWith")) {
            ret.descEndsWith(map.get("descEndsWith").toString());
        }
        if (map.containsKey("descStartsWith")) {
            ret.descStartsWith(map.get("descStartsWith").toString());
        }
        if (map.containsKey("clickable")) {
            ret.clickable((Boolean) map.get("clickable"));
        }
        if (map.containsKey("checked")) {
            ret.checked((Boolean) map.get("checked"));
        }
        if (map.containsKey("checkable")) {
            ret.checkable((Boolean) map.get("checkable"));
        }
        if (map.containsKey("selected")) {
            ret.selected((Boolean) map.get("selected"));
        }
        if (map.containsKey("checkable")) {
            ret.checkable((Boolean) map.get("checkable"));
        }
        if (map.containsKey("hasChild")) {
            ret.hasChild(map((Map) map.get("hasChild")));
        }
        if (map.containsKey("hasDescendant")) {
            ret.hasDescendant(map((Map) map.get("hasDescendant")));
        }
        ...
        if (map.containsKey("focusable")) {
            ret.focusable((Boolean) map.get("focusable"));
        }
        if (map.containsKey("focused")) {
            ret.focused((Boolean) map.get("focused"));
        }
        return ret;
    }
