...
;       push    edx             ; need not be preserved
        ...
        ; ---- Pass 1: progress columns from input, store into work array.
...
.nextcolumn:
        ...
        ; ---- Pass 2: progress rows from work array, store into output array.
...
;       push    edx             ; need not be preserved
        ...
        ; ---- Pass 1: progress columns from input.
        ...
        ; ---- Pass 2: progress rows, store into output array.
