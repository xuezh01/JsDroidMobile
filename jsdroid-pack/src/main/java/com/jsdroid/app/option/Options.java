...
public class Options {
    ...
    public static void addOptions(QMUIGroupListView groupListView, String sectionTitle, boolean useTitleViewForSectionSpace, OptionItem... items) {
        QMUIGroupListView.Section section = QMUIGroupListView.newSection(groupListView.getContext()).
                setUseTitleViewForSectionSpace(useTitleViewForSectionSpace).setTitle(sectionTitle);
        for (final OptionItem item : items) {
            ...
            if (item.iconRes != null) {
                ...
                item.itemView.setImageDrawable(createMenuDrawable(groupListView.getContext(), R.drawable.option));
            }
