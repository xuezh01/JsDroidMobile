...
public class HVScrollView extends FrameLayout {
    ...
    /**
     * When set to true, the scroll view measureMarginAndPadding its child to make it fill the currently
     * visible area.
     */
    ...
    /**
     * Indicates whether this ScrollView's type is stretched to fill the viewport.
     *
     * @return True if the type fills the viewport, false otherwise.
     */
    ...
    /**
     * Indicates this ScrollView whether it should stretch its type height to fill
     * the viewport or not.
     *
     * @param fillViewport True to stretch the type's height to the viewport's
    ...
    public void computeScroll() {
        if (mScroller.computeScrollOffset()) {
            ...
            // re-compareStart the scrollbars at this point, which scrollTo will do,
    ...
    protected int computeScrollDeltaToGetChildRectOnScreenV(Rect rect) {
        ...
        if (rect.bottom > screenBottom && rect.top > screenTop) {
            ...
            // make sure we aren't scrolling beyond the end of our type
