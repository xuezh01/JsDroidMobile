...
import static com.jsdroid.groovy.antlr4.parser.util.StringUtils.matches;
import static com.jsdroid.groovy.antlr4.parser.GroovyParser.*;
...
public class SemanticPredicates {
    ...
    public static boolean isFollowingArgumentsOrClosure(ExpressionContext context) {
        if (context instanceof ExpressionPostfixExprAltContext) {
            List<ParseTree> peacChildren = ((ExpressionPostfixExprAltContext) context).children;
    ...
    private static final List<Integer> MODIFIER_SET =
            newArray(
                    ANNOTATION_TYPE,
                    DEF,
                    VAR,
    ...
    public static <E> List<E> newArray(E... elements) {
